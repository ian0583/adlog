...
if (file_exists ( APP_MODULES . $currentModuleConfig ['path'] ) &&
		 (! isset ( $currentModuleConfig ['template'] ) || file_exists ( APP_TEMPLATES . $currentModuleConfig ['template'] )) &&
		 (! isset ( $currentModuleConfig ['body'] ) || file_exists ( APP_TEMPLATES . @$currentModuleConfig ['body'] )))
{
